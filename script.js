...
function goTown() {
    update(locations[0]);
	body.style.backgroundImage="url('images/town.webp')";
}

function goStore() {
    update(locations[1]);
	body.style.backgroundImage="url('images/store.webp')";
}

function goCave() {
    update(locations[2]);
	body.style.backgroundImage="url('images/cave.webp')";
}
...
function buyWeapon() {
    if (currentWeapon < weapons.length - 1) {
    	if (gold >= 30) {
			...
			body.style.backgroundImage="url('images/buyWeapon.webp')"
    	} else {
...
function fightSlime() {
	fighting = 0;
	goFight();
	body.style.backgroundImage="url('images/slime.webp')";
}

function fightBeast() {
	fighting = 1;
	goFight();
	body.style.backgroundImage="url('images/beast.webp')";
}

function fightDragon() {
	fighting = 2;
	goFight();
	body.style.backgroundImage="url('images/dragon.webp')";
}
...
function dodge() {
	...
	body.style.backgroundImage="url('images/dodge.webp')";
}
...
function lose() {
    update(locations[5]);
	 ...
	 body.style.backgroundImage="url('images/lose.webp')";

}

function winGame() {
  update(locations[6]);
  body.style.backgroundImage="url('images/win.webp')";
}
